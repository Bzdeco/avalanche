...
public class LasFileReader {
    ...
    public List<LasVariableLengthRecord> getVariableLengthRecordList() {
        List<LasVariableLengthRecord> list = new ArrayList<LasVariableLengthRecord>();
        list.addAll(vlrList);
        return list;
    }
...
//        File file = new File("/home/maciejs/Documents/Projekt_lawinowy_dane/rolne_fragment.las");
